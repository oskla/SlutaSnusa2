...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding?.apply {
            ...
            sharedViewModel.daysWithout.value?.let { sharedViewModel.totalValuesAnimator(twMoneySaved,
                it
            ) }
            sharedViewModel.totalMoneySaved.value?.let { sharedViewModel.totalValuesAnimator(twDaysWithout,
                it
            ) }
        }
